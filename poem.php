        ...
        <div class="w3-row">
          <div class="w3-bar-item w3-black  w3-xlarge w3-padding-16 " >
             <a href="home.php"  class="w3-bar-item w3-button w3-wide "><img s=""></img></a>
      ...
      <div class=" w3-panel w3-margin w3-text-red" > 

      <h4><strong>साहित्य प्रकार</strong> </h4>
      ...
      <h1> कविता </h1>
       ...
       <div class="w3-card-4 w3-margin w3-white">
            <div class="w3-container w3-text-black">
              <h4>
                <img typeof="foaf:Image" class="img-responsive w3-circle" src="images/thumb.jpg" alt="ज्योति अलवनि's picture">  
                <b>हनुमान कऱ्हाळे </b>
              </h4>
            ...
            <div class="w3-container">
               <p>        
                      ...
                      <p>प्रीती तुझ्यावरी पण,समजे मलाच नाही.<br>
                       या अनाकलनाचा,मी काय अर्थ घ्यावा? </p>
                      <p>शब्दात सांगताना,उरते मनात काही.<br>
                      या गूढ शांततेचा,मी काय अर्थ घ्यावा?</p>
                      <p>एका किनारी तूही ,दुसय्रास स्पर्श माझा.<br>
                      मधल्या प्रवाहितेचा,मी काय अर्थ घ्यावा?</p>
                      <p>मोडून एक काठ,वळते नदी जराशी.<br>
                      मग शांत त्या तळाशी,कोठून सूर द्यावा?</p>
          ...
          <!-- Blog entry -->
           ...
           <div class="w3-card-4 w3-margin w3-white">
            <div class="w3-container w3-text-black">
              <h4>
                <img typeof="foaf:Image" class="img-responsive" src="http://www.misalpav.com/sites/all/themes/mipadashak/images/user-pic.png" alt="ज्योति अलवनि's picture">  
                <b>हनुमान कऱ्हाळे </b>
              </h4>
              <h5>Title description, <span class="w3-opacity">April 7, 2014</span></h5>
            </div>
            ...
            <div class="w3-container">
               <p>        
                  ...
                  <p>अवेळी मोहरावे तू.. ऋतूंना साद घालावी<br>
                  तुझ्या नाजूक ओठांनी कळ्यांची चुंबने घ्यावी!</p>
                  <p>फुले वेचून मी सारी तुझ्या हातात देताना<br>
                  तुझ्या अलवार स्पर्शांनी मला आलिंगने द्यावी!</p>
...
.... 
          ...
          <!-- Blog entry -->
           <div class="w3-card-4 w3-margin w3-white">
            ...
            <div class="w3-container w3-text-red">
                <h4 ><b>अस्वस्थ न्यायव्यवस्था?</b></h4>
            </div>
            ...
            <div class="w3-container">
               <p>        
                        ...
                        माझ्या सर्व दार आणि खिडक्या आज बंद आहेत 
                        एव्हडं बघून मी माझ्यातला ऐवज रोज एकदा काढत आहे 
                        पुन्हा एकदा गिरवण्यासाठी..
                        कित्येक वर्षांचा साठलेला मनाचा कोपरा 
                        उघडण्यासाठी 
                        माझं दार बंद असावं लागत..
                        झाकलेलंच आहे तर उघडायचं कशाला 
                        एवढ्याच कारणासाठी
                        माझ्या बंद खिडकीच्या आत. 

                    माझ्या रोजनिशीतल हे पहल पान
                    आणि शेवटचं.... 
        ...
        <div class="w3-col l4">
          <!-- About Card -->
           <!-- Profile -->
              <div class="w3-card w3-round w3-white w3-padding w3-margin">
                <div class="w3-container">
                 <h4 class="w3-center">My Profile</h4>
                 <p class="w3-center"><img src="/w3images/avatar3.png" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
                 <hr>
                 <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Poet</p>
                 <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Nanded, India</p>
       ...
       <div class="w3-card w3-round w3-white w3-padding w3-margin">
        ...
        <div class="panel-body">
          <form action="/story?destination=story" method="post" id="user-login-form" accept-charset="UTF-8"><div><div class="form-item form-item-name form-type-textfield form-group">
          <label class="control-label" for="edit-name">सदस्यनाम <span class="form-required" title="This field is required.">*</span></label>
          <input class="form-control form-text required" id="edit-name" name="name" value="" size="15" maxlength="60" type="text"></div><script type="text/javascript">_gph_edit_name = new gamabhanaPhoneticHandler('edit-name','__devanagari__','__roman__','#gamabhana#');</script><div class="form-item form-item-pass form-type-password form-group"> <label class="control-label" for="edit-pass">संकेताक्षर <span class="form-required" title="This field is required.">*</span></label>
          <input class="form-control form-text required" id="edit-pass" name="pass" size="15" maxlength="128" type="password"></div><ul><li><a href="/user/register" title="Create a new user account."><font color="red"> वसुंधराचे  सदस्य व्हा !</font></a></li>
          <li><a href="/user/password" title="नवीन संकेताक्षर ईमेल द्वारे मागवा."><font color="red"> नवीन संकेताक्षर बोलवा.</font></a></li>
          </ul><input name="form_build_id" value="form-sCwGvNN0jN0mlWO6LJ-fAaV8A1KYHkD4WSW198I0eSo" type="hidden">
