                      ...
                      <div class="w3-col l8 s12">
                          ...
                          <div class="w3-row-padding w3-margin">
                            <div class="w3-col m12">
                              <div class="w3-card w3-round w3-pale-red">
                                <div class="w3-container w3-padding">
                                  <h6 class="w3-opacity "><i class="fa fa-pencil"></i>compose post</h6>
                                  <p contenteditable="true" class="w3-border w3-white w3-padding-16"></p>
                                  <button type="button" class="w3-button w3-theme w3-hover-red "><i class="fa fa-pencil"></i>  Post</button> 
                                </div>
                              </div>
                            </div>
                          </div>
                 ...
                 <div class="w3-card-4 w3-margin w3-white">
                      <div class="w3-container w3-text-black">
                         ...
                         <div class="w3-container">
                              <a href="#" class="w3-text-red" style="text-decoration:none"><h4><b>अस्वस्थ न्यायव्यवस्था?</b></h4></a>
                         </div>
                      <div class="w3-container">
                             <p>        
                                  रोजनिशी 
                    ...
                    <!-- Blog entry -->
                 <div class="w3-card-4 w3-margin w3-pale-red">
                      <div class="w3-container w3-text-black">
                         <h4>
                          <b>हनुमान कऱ्हाळे </b>
                        </w3-pale-red>
